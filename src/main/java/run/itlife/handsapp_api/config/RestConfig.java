    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .cors(c -> c.configurationSource(request -> {
                    ...
                    cors.setAllowedOrigins(Arrays.asList("https://localhost:8443/refresh", "https://localhost:8443/token", "https://localhost:8443", "https://localhost:8443/", "https://localhost:8443/posts_ms", "http://localhost:8081/refresh", "http://localhost:8081/token", "http://localhost:8081", "http://localhost:8081/", "http://localhost:3000", "http://localhost:3000/", "http://localhost:3000/posts", "http://localhost:3000/refresh", "http://localhost:3000/token"));
