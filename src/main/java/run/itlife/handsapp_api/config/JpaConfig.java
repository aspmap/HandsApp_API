...
@EnableJpaRepositories("run.itlife.handsapp_api.repository")
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() { //он заменяет Hibernate’овский sessionFactory
        ...
        em.setPackagesToScan("run.itlife.handsapp_api.entity");
    ...
    private Properties hibernateProperties() { // необходим для того, чтобы передать ему базовые свойства
